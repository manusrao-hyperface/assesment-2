...
const icons = {
  ...
  "dot": <svg enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><circle cx="256" cy="256.167" fill="#00b1ff" r="223.167"/></svg>,
...
function App() {
  ...
  return (
    <div className="App" style={{maxHeight:"100px"}}>
      <Carousel images={images} options={options}/>
      <ScrollCarousel images={images} options={options2}/>
    </div>
  );
}
